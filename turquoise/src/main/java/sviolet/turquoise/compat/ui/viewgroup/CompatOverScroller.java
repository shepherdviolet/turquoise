...
package sviolet.turquoise.compat.ui.viewgroup;
 ...
 * {@link CompatScroller} in most cases.
 */
//api24
public class CompatOverScroller {
    private int mMode;
     ...
     * @param context
     */
    public CompatOverScroller(Context context) {
        this(context, null);
    }
     ...
     * be used.
     */
    public CompatOverScroller(Context context, Interpolator interpolator) {
     ...
     * @hide
     */
    public CompatOverScroller(Context context, Interpolator interpolator, boolean flywheel) {
        if (interpolator == null) {
            mInterpolator = new CompatScroller.ViscousFluidInterpolator();
        } else {
    ...
    static class SplineOverScroller {
        ...
        void finish() {
            ...
            // TO DO: restore when WebView uses the fast fling implemented in this class.
            // mCurrVelocity = 0.0f;
            mFinished = true;
        }
            ...
            switch (mState) {
                case SPLINE:
                    ...
                    if (mDuration < mSplineDuration) {
                        ...
                        // TO DO Better compute speed when edge was reached
