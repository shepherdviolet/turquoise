...
import sviolet.turquoise.uix.slideengine.logic.LinearScrollEngine;
...
public class RelativeLayoutDrawer extends RelativeLayout implements SlideView {
	...
	public RelativeLayoutDrawer(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	 ...
	 * @return
	 */
	public RelativeLayoutDrawer setSlideDrawerWidth(int drawerWidth){
	 ...
	 * @return
	 */
	public RelativeLayoutDrawer setSlideHandleWidth(int handleWidth){
	 ...
	 * @return
	 */
	public RelativeLayoutDrawer setSlideScrollDuration(int scrollDuration){
	 ...
	 * @return
	 */
	public RelativeLayoutDrawer setSlideOverScrollEnabled(boolean overScrollEnabled){
	 ...
	 * @return
	 */
	public RelativeLayoutDrawer setSlideOverScrollDamp(float overScrollDamp){
	 ...
	 * @return
	 */
	public RelativeLayoutDrawer setHandleFeedback(boolean enabled){
	 ...
	 * @return
	 */
	public RelativeLayoutDrawer setHandleFeedbackRange(int range){
