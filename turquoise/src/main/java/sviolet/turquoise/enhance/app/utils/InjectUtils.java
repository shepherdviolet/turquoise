...
import sviolet.turquoise.enhance.app.annotation.inject.OnClickMethod;
 ...
 * 3.根据"成员方法"的@OnClickMethod注释绑定对应View的点击监听器, 方法仅有一个View参数时传入OnClickListener的View参数, 不建议使用<Br/>
 *
...
//        InjectUtils.injectMethodAnnotation(activity);// 注入成员方法的注释, 不建议使用
    }
